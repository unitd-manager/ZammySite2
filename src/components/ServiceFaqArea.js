...
import faqshape1 from "../assets/images/faq/shape/01.png"
import faqshape2 from "../assets/images/faq/shape/02.png"
import faqshape3 from "../assets/images/faq/shape/03.png"
import faqshape4 from "../assets/images/faq/shape/04.png"
...
function ServiceFaqArea() {
  ...
  <div className="shape-area">
    <img src={faqshape1} alt="sahpe" className="one" />
    <img src={faqshape2} alt="sahpe" className="two" />
    <img src={faqshape3} alt="sahpe" className="three" />
    <img src={faqshape4} alt="sahpe" className="four" />
  </div>
</div>
